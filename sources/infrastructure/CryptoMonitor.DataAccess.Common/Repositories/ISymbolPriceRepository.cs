...
namespace CryptoMonitor.DataAccess.Common.Repositories
{
    public interface ISymbolPriceRepository
    {
        ...
        Task<(IReadOnlyCollection<SymbolPrice> Items, long TotalCount)> ListAsync(int skip = 0, int take = 50, string sellSymbol = null, string buySymbol = null, SymbolSource? symbolSource = null, string query = null, string orderBy = null, bool asc = true);
    }
}